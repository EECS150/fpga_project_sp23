...
\item \verb|software|
  ...
  \item \verb|benchmark|:
    ...
    \item \verb|ssort|:
      This benchmark program performs selection sort.
    \item \verb|spath|:
      This benchmark program computes shortest paths using Diskstra's algorithm.
    \item \verb|tspex|:
      This benchmark program calculates the exact solution for the travelling salesman problem using branch and bound.
    \end{itemize}
  \item \verb|small|:
